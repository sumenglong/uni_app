<template>
	<view class="uni-container">
		<uni-forms ref="form" v-model="formData" :rules="rules" validateTrigger="bind" @submit="submit">
			<uni-forms-item name="role_id" label="部门编号" required>
				<uni-easyinput v-model="formData.role_id" :clearable="false" placeholder="请输入部门编号" />
			</uni-forms-item>
			<uni-forms-item name="role_name" label="部门名称" required>
				<uni-easyinput v-model="formData.role_name" :clearable="false" placeholder="请输入部门名称" />
			</uni-forms-item>
	...
	export default {
		data() {
			return {
				...
				rules: {
					...getValidator(["role_id", "role_name"])
				},
				permissions: []
			}
		},

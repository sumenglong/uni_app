<template>
	<view class="uni-container">
		<uni-forms ref="form" v-model="formData" :rules="rules" validateTrigger="bind" @submit="submit">
			<uni-forms-item name="role_id" label="流程编号" required>
				<uni-easyinput v-model="formData.role_id" :clearable="false" placeholder="请输入流程编号" />
			</uni-forms-item>
			<uni-forms-item name="role_name" label="流程名称" required>
				<uni-easyinput v-model="formData.role_name" :clearable="false" placeholder="请输入流程名称" />
			</uni-forms-item>
			<uni-forms-item name="permission" label="所属部门">
			...
			<uni-forms-item name="comment" label="说明">
				<uni-easyinput type="textarea" v-model="formData.comment" :clearable="false" placeholder="请输入说明" />
			</uni-forms-item>

	...
	<view>
		<view class="uni-header">
			<view class="uni-group hide-on-phone">
				<view class="uni-title">我的任务</view>
			...
			<unicloud-db ref="udb" @load="onqueryload" collection="uni-id-roles,uni-id-permissions" :options="options"
				...
				<uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
					...
					<uni-tr v-for="(item,index) in data" :key="index">
						...
						<uni-td align="center">个</uni-td>
						<uni-td align="center">2</uni-td>
						<uni-td align="center">高</uni-td>
						<uni-td align="center">无</uni-td>
						...
						<uni-td align="center">
							...
							<view v-else class="uni-group">
								<navigator url="" size="mini" type="primary" class="uni-button2">提交</navigator>

<template>
	<view class="uni-container">
		<uni-forms ref="form" v-model="formData" :rules="rules" validateTrigger="bind" @submit="submit">
			<uni-forms-item name="role_id" label="任务名称" required>
				<uni-easyinput v-model="formData.role_id" :clearable="false" placeholder="请输入任务名称" />
			</uni-forms-item>
			<uni-forms-item name="role_name" label="类别" required>
				<uni-easyinput v-model="formData.role_name" :clearable="false" placeholder="请输入类别" />
			</uni-forms-item>
			<uni-forms-item name="permission" label="人员">
			...
			<uni-forms-item name="comment" label="数量">
